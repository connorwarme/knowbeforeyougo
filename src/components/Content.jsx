...
const Content = ({ content }) => {
  const listStyle =
    "list-none border-b-2 border-deep mb-4 last-of-type:border-b-0";
  const titleStyle =
    "font-display font-semibold text-lg my-2 sm:text-xl lg:text-3xl";
  return (
    <div className="cardContent">
      ...
      {content.poems && (
        <ul className={listStyle}>
          <h3 className={titleStyle}>
            {content.poems.length > 1 ? "Poems" : "Poem"}
          </h3>
      ...
      {content.quotes && (
        <ul className={listStyle}>
          <h3 className={titleStyle}>
            {content.quotes.length > 1 ? "Quotes" : "Quote"}
          </h3>
